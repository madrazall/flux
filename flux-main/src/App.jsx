...
function AuthScreen() {
  ...
  return (
    <div style={{
      ...
      <style>{`@import url('https://fonts.googleapis.com/css2?family=DM+Mono:wght@300;400;500&family=Bebas+Neue&display=swap');*{box-sizing:border-box;margin:0;padding:0}button{font-family:inherit}`}</style>
      <div style={{ width: "100%", maxWidth: 360, textAlign: "center" }}>
        <div style={{ fontFamily: "'Bebas Neue',sans-serif", fontSize: 48, letterSpacing: 4, color: C.accent, marginBottom: 4 }}>FLUX</div>
        <div style={{ fontSize: 10, color: C.textDim, letterSpacing: 3, marginBottom: 48, textTransform: "uppercase" }}>Daily Schedule + Journal</div>
        ...
        {!sent ? (
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            <input
              ...
              style={{
                ...
                color: C.text, borderRadius: 4, padding: "12px 14px", fontSize: 13,
                outline: "none", fontFamily: "inherit"
              }}
            />
            {error && <div style={{ fontSize: 12, color: "#ff6d6d" }}>{error}</div>}
            <button
              onClick={handleMagicLink}
              disabled={loading}
              style={{
                width: "100%", background: C.accent, border: "none", color: "#fff",
                borderRadius: 4, padding: "12px", fontSize: 13, cursor: loading ? "default" : "pointer",
                fontFamily: "inherit", fontWeight: 500, opacity: loading ? 0.6 : 1,
          ...
          <div style={{ padding: "20px", background: C.card, border: `1px solid ${C.border}`, borderRadius: 4 }}>
            <div style={{ fontSize: 13, color: C.text, marginBottom: 8 }}>✓ Check your email!</div>
            ...
            <button
              ...
              style={{
                ...
                borderRadius: 4, padding: "8px 16px", fontSize: 11, cursor: "pointer",
                fontFamily: "inherit"
              }}>
              Use different email
            </button>
