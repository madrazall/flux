...
function AuthScreen({ onAuth }) {
  ...
  <span style={{fontSize:10,color:"#50505a",letterSpacing:1}}>OR</span>
  <div style={{flex:1,height:"1px",background:"#2a2a2e"}}/>
</div>
<button onClick={async()=>{await supabase.auth.signInWithOAuth({provider:"google",options:{redirectTo:window.location.origin}})}} style={{width:"100%",background:"#fff",border:"none",color:"#1a1a1a",borderRadius:4,padding:"12px",fontSize:13,cursor:"pointer",fontFamily:"inherit",fontWeight:500,display:"flex",alignItems:"center",justifyContent:"center",gap:10}}>
